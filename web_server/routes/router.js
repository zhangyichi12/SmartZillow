...
var redis_client = require('../cache/redis_client.js')
...
router.get('/search', function (req, res, next) {
    ...
    // redis_client.redis_get(query, function(redis_res) {
    //     if (!redis_res) {
...
router.get('/detail', function (req, res, next) {
    ...
    redis_client.redis_get(id, function (redis_res) {
        if (!redis_res) {
            rpc_client.getDetailsByZpid(id, function (response) {
                ...
                redis_client.redis_set(id, property);
            });
        }
        else {
